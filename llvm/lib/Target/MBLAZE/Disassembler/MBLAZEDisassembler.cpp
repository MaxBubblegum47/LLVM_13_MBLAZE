//===- MBLAZEDisassembler.cpp - Disassembler for MBLAZE ---------------*- C++ -*-===//
//
...
///
/// \file
/// This file is part of the MBLAZE Disassembler.
///
//===----------------------------------------------------------------------===//
...
#define DEBUG_TYPE "MBLAZE-disassembler"

using DecodeStatus = MCDisassembler::DecodeStatus;

namespace {

/// A disassembler class for MBLAZE.
...
static const uint16_t GPR32DecoderTable[] = {
    MBLAZE::R0,  MBLAZE::R2,  MBLAZE::R3,   MBLAZE::R4,  MBLAZE::R5,  MBLAZE::R6,
    MBLAZE::R7,  MBLAZE::R8,    MBLAZE::R9,  MBLAZE::R10,  MBLAZE::R11, MBLAZE::R12, MBLAZE::R13,
    MBLAZE::R14, MBLAZE::R15,   MBLAZE::R16, MBLAZE::R17,  MBLAZE::R18, MBLAZE::R19, MBLAZE::GP,
    MBLAZE::R21, MBLAZE::R22,   MBLAZE::R23, MBLAZE::R24,  MBLAZE::R25, MBLAZE::R26,  MBLAZE::FP,
    MBLAZE::R28,  MBLAZE::ILINK, MBLAZE::R30, MBLAZE::BLINK};
...
#include "MBLAZEGenDisassemblerTables.inc"
...
DecodeStatus MBLAZEDisassembler::getInstruction(MCInst &Instr, uint64_t &Size,
...
static MCDisassembler *createMBLAZEDisassembler(const Target &T,
                                             ...
                                             MCContext &Ctx) {
  return new MBLAZEDisassembler(STI, Ctx, T.createMCInstrInfo());
}

extern "C" LLVM_EXTERNAL_VISIBILITY void LLVMInitializeMBLAZEDisassembler() {
  // Register the disassembler.
  TargetRegistry::RegisterMCDisassembler(getTheMBLAZETarget(),
