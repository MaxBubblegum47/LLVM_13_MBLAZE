//===- MBLAZEISelDAGToDAG.cpp - MBLAZE dag to dag inst selector -------*- C++ -*-===//
//
...
public:
  ...
  bool SelectCMOVPred(SDValue N, SDValue &Pred, SDValue &Reg) {
    ...
    Reg = CurDAG->getRegister(MBLAZE::STATUS32, MVT::i32);
    return true;
  }
...
/// This pass converts a legalized DAG into a MBLAZE-specific DAG, ready for
...
bool MBLAZEDAGToDAGISel::SelectAddrModeImm(SDValue Addr, SDValue &Base,
                                        SDValue &Offset) {
  if (Addr.getOpcode() == MBLAZEISD::GAWRAPPER) {
...
bool MBLAZEDAGToDAGISel::SelectAddrModeS9(SDValue Addr, SDValue &Base,
                                       SDValue &Offset) {
  if (Addr.getOpcode() == MBLAZEISD::GAWRAPPER) {
    return false;
  }
...
bool MBLAZEDAGToDAGISel::SelectAddrModeFar(SDValue Addr, SDValue &Base,
                                        SDValue &Offset) {
...
bool MBLAZEDAGToDAGISel::SelectFrameADDR_ri(SDValue Addr, SDValue &Base,
                                         SDValue &Offset) {
