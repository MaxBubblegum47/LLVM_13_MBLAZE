...
#define DEBUG_TYPE "MBLAZE-mccode-emitter"

STATISTIC(MCNumEmitted, "Number of MC instructions emitted");

unsigned MBLAZEMCCodeEmitter::getOImmOpValue(const MCInst &MI, unsigned Idx,
...
void MBLAZEMCCodeEmitter::encodeInstruction(const MCInst &MI, raw_ostream &OS,
                                          SmallVectorImpl<MCFixup> &Fixups,
                                          const MCSubtargetInfo &STI) const {
...
unsigned
MBLAZEMCCodeEmitter::getMachineOpValue(const MCInst &MI, const MCOperand &MO,
                                     SmallVectorImpl<MCFixup> &Fixups,
                                     const MCSubtargetInfo &STI) const {
  if (MO.isReg())
...
MCCodeEmitter *llvm::createMBLAZEMCCodeEmitter(const MCInstrInfo &MCII,
  ...
  return new MBLAZEMCCodeEmitter(Ctx, MCII);
}
