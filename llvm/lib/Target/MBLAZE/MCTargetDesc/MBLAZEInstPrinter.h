...
///
/// \file
/// This file contains the declaration of the MBLAZEInstPrinter class,
/// which is used to print MBLAZE MCInst to a .s file.
///
//===----------------------------------------------------------------------===//

#ifndef LLVM_LIB_TARGET_MBLAZE_INSTPRINTER_MBLAZEINSTPRINTER_H
#define LLVM_LIB_TARGET_MBLAZE_INSTPRINTER_MBLAZEINSTPRINTER_H
...
#endif // LLVM_LIB_TARGET_MBLAZE_INSTPRINTER_MBLAZEINSTPRINTER_H
